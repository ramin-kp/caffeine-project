  ...
  return (
    <div className="relative px-[9px] mt4 lg:mt-6" data-aos="fade-up">
      ...
      >
        <SwiperSlide>
          <div className="relative">
            ...
            <div className="flex items-start  flex-col absolute  right-5 top-5 md:right-10 md:top-10 lg:top-20 lg:right-40 xl:right-48  text-white">
              ...
              >
                <p className="hidden lg:flex ml-1"> مشاهده </p> فروشگاه
        ...
        <div
          className="container absolute  flex items-center justify-end gap-x-3 left-4 lg:left-0 bottom-5 z-30 child:cursor-pointer
                child:bg-white 
                child:dark:bg-zinc-700 child:shadow child:rounded-full child:p-1 child:lg:p-1.5 "
        >
          <button className="button-prev" ref={prevButton}>
            <svg className="w-5 h-5">
              <use href="#arrow-long-right"></use>
            </svg>
          </button>
          <button
            className="button-next dark:bg-zinc-700 shadow rounded-full p-1 lg:p-1.5"
            ref={nextButton}
          >
            <svg className="w-5 h-5">
